...
//taking user input and storing to hooks later we'll transfer it to firebase Realtime Database 
...
// Connecting with firebase while using submitData function to store data to firebase
const submitData = async (event) => {
    ...
    if (name && email && message) {
      const res = fetch(
        "https://teamoxygen-database-default-rtdb.firebaseio.com/userDataRecords.json",
        {
          method: "POST",
          headers: {
      ...
      if (res) {
        ...
        alert("Got Ya, See ya soon");
      } else {
        alert("Oops, Did You Fill The Form ?");
      }
    } else {
      alert("Oops, Did You Fill The Form ?");
    }
  ...
  <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto e-bg text-gray-900 rounded-lg shadow-lg">
    <div className="flex flex-col justify-between">
      <div>
        <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
          Lets talk about Custom Rom, & Front End Development!
        </h2>
        <div className="text-gray-700 mt-8">
          Hate forms? Send us an <a className="underline" href="mailto:Mohsindev798@gmail.con">email</a> <span></span>
          instead.
        </div>
      </div>
    ...
    <div className>
      <div>
        ...
        <input type="name" required name="name" value={userData.name} onChange={sendUserData}
          className="w-full bg bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
          type="text"
          placeholder
        />
      </div>
      <div className="mt-8">
        ...
        <input typeof="email" id="email" required name="email" value={userData.email} onChange={sendUserData}
          className="w-full bg-gray-300 bg text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
          type="text"
        />
      </div>
      <div className="mt-8">
        ...
        <textarea type="message" required name="message" value={userData.message} onChange={sendUserData}
          className=" bg w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
          defaultValue={""}
        />
      </div>
      <div className="mt-8">
        <button onClick={submitData} type="submit" className="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
          Send Message
        </button>
